        ...
        <div className='container p-8'>
          <div className='flex flex-wrap -mx-4 lg:justify-between'>
            ...
            <div className='w-full px-4 lg:w-1/2 xl:w-5/12'>
              <div className='relative p-8 bg-slate-50 dark:bg-slate-950 rounded-lg shadow-lg sm:p-12'>
                <form
                  id='myForm'
                  action={`https://formbold.com/s/${process.env.NEXT_PUBLIC_FORMKEY}`}
                  method='POST'
                >
                  <ContactInputBox
                    type='text'
